    ...
    <div className="w-full h-fit flex flex-col items-center justify-center text-white bg-transparent">
      <div className="w-[90%] h-fit text-center flex flex-col gap-8">
        ...
        <p className="w-[90%] sm:w-[80%] lg:w-[65%] m-auto lg:text-[24px] text-[17px] text-[#D1D1D6]">
          Subscribe to receive our exclusive reports and research, gaining
          valuable insights into the work we do and the MSMEs we support through
          the Digital Aba project.
        </p>
